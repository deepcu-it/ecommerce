...
const Login = () => {
    ...
    return (
        ...
        <div className="container"> 
            ...
            <div class="title-2"><span>Hello</span></div>
            <div class="input-container">
            <input class="input-mail" onChange={(e)=> setEmail(e.target.value)} type="email" placeholder="Enter email"/>
            <span> </span>
            </div>
            ...
            <div class="input-container">
            <input onChange={(e)=> setPassword(e.target.value)} class="input-pwd" type="password" placeholder="Enter password"/>
            </div>
